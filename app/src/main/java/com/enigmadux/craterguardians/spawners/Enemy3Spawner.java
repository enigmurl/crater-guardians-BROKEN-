...
public class Enemy3Spawner extends Spawner {
    ...
    public Enemy3Spawner(Context context,int instanceId, float x, float y, float w, float h, int orangeEndHealth, int blue1EndHealth, int maxHealth, long blue1, long orange, long blue2, short[] numBlueSpawns, long[] blueSpawnJuice, short[] numOrangeSpawns, long[] orangeSpawnJuice,int strength) {
        super(context,instanceId, x, y, w, h, orangeEndHealth, blue1EndHealth, maxHealth, blue1, orange, blue2, numBlueSpawns, blueSpawnJuice, numOrangeSpawns, orangeSpawnJuice,strength);
    ...
    public void spawnBlueEnemies(int numEnemies, CraterCollection<Enemy> blueEnemies) {
        for (int i = 0;i<numEnemies;i++){
            ...
            blueEnemies.addInstance(new Enemy3(id,x,y,true,strength));
        }
    }
    ...
    public void spawnOrangeEnemies(int numEnemies, CraterCollection<Enemy> orangeEnemies) {
        for (int i = 0;i<numEnemies;i++){
            ...
            orangeEnemies.addInstance(new Enemy3(id,x,y,false,strength));
        }
    }
}
