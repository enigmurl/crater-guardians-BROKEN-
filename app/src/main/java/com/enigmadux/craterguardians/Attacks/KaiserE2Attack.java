...
/** this whole subdirectory needs javadoc //TODO Also make this different the e1 in more ways
 *
 */
public class KaiserE2Attack extends Attack {
    ...
    public boolean isHit(Supply supply) {
        return false;//don't waste calculation time seeing if it is hit because it doesn't matter
    }
