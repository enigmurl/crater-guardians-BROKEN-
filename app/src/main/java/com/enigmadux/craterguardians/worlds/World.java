...
public class World {
    ...
    //how far back the camera
    private static final float DEFAULT_CAMERA_Z = 3;
    ...
    public World(Context context,HashMap<String, GUILayout> guilayouts){
        ...
        this.blueEnemies.loadTexture(context, R.drawable.enemy1_sprite_sheet);
        this.orangeEnemies = new CraterCollection<>(256,World.QUAD_VERTICES,Enemy1.TEXTURE_MAP,World.QUAD_INDICES);

        this.orangeEnemies.loadTexture(context,R.drawable.enemy1_sprite_sheet);
    ...
    public void draw(float[] scaleMatrix,float[] orthoMatrix){
        ...
        if (this.mState == World.STATE_INGAME ||
            ...
            //this.guiRenderer.bufferQuad(this.craterVisual);
    ...
    public float getCameraZoom(){
        if (this.mState != World.STATE_PREGAME){
            ...
            float endTarget = World.DEFAULT_CAMERA_Z * LayoutConsts.SCREEN_HEIGHT/LayoutConsts.SCREEN_WIDTH;
