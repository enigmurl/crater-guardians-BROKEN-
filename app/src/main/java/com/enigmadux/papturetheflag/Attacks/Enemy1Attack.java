...
public class Enemy1Attack extends Attack {
     ...
     */
    public Enemy1Attack(float x,float y,int damage,float sweepRadians, float angleRadians,float length,long millis){
        super(x,y,0,0,5,millis);

        Log.d("enemy1Attack", "angle: " + angleRadians);
    ...
    public void loadGLTexture(@NonNull GL10 gl, Context context) {
        super.loadGLTexture(gl, context, R.drawable.kaiser_attack_spritesheet);//todo
